...
class _ListsWidgetState extends State<ListsWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<LeerListasRow>>(
      future: SQLiteManager.instance.leerListas(),
      builder: (context, snapshot) {
        ...
        final listsLeerListasRowList = snapshot.data!;
                          ...
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                child: Builder(
                                  builder: (context) {
                                    if (listsLeerListasRowList.length == 0) {
                                      return Align(
                                        alignment:
                                      ...
                                      return FutureBuilder<List<LeerListasRow>>(
                                        future:
                                            SQLiteManager.instance.leerListas(),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                          ...
                                          final listViewLeerListasRowList =
                                              snapshot.data!;
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemCount: listViewLeerListasRowList
                                                .length,
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 20.0),
                                            itemBuilder:
                                                (context, listViewIndex) {
                                              final listViewLeerListasRow =
                                                  listViewLeerListasRowList[
                                                      listViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Stack(
                                                        children: [
                                                          if (listViewLeerListasRow
                                                                      .rutaImagen ==
                                                                  null ||
                                                              listViewLeerListasRow
                                                                      .rutaImagen ==
                                                                  '')
                                                            Padding(
                                                              padding:
                                                          ...
                                                          if (listViewLeerListasRow
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: Image
                                                                    .network(
                                                                  'file://${listViewLeerListasRow.rutaImagen}',
                                                                  width: 50.0,
                                                                  height: 50.0,
                                                                  fit: BoxFit
                                                                      .cover,
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                '${listViewLeerListasRow.cantidadCanciones.toString()} canciones',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
