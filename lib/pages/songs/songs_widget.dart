                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    FFAppState()
                                                                        ...
                                                                        listSongsItem
                                                                            .album;
                                                                    FFAppState().colaIds = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .id)
                                                                        .toList()
                                                                        .cast<
                                                                            int>();
                                                                    FFAppState().colaTitulos = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .titulo)
                                                                        .toList()
                                                                        .cast<
                                                                            String>();
                                                                    FFAppState().colaArtistas = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .artista)
                                                                        .toList()
                                                                        .cast<
                                                                            String>();
                                                                    FFAppState().colaRutas = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .ruta)
                                                                        .toList()
                                                                        .cast<
                                                                    ...
                                                                    FFAppState()
                                                                            .currentIndex =
                                                                        listSongsIndex;
                                                                    FFAppState().colaAlbums = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .album)
                                                                        .toList()
                                                                        .cast<
                                                                            String>();
                                                                    FFAppState().colaColores = songsListSongsRowList
                                                                        .map((e) => e
                                                                            .color)
                                                                        .toList()
                                                                        .cast<
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            height:
                                                                                40.0,
                                                                            child:
                                                                                custom_widgets.MiniSongCover(
                                                                              width: 40.0,
                                                                              height: 40.0,
                                                                              cancionId: listSongsItem.id,
                                                                            ),
                                                                          ),
                                                                        ),
                                                                        Padding(
